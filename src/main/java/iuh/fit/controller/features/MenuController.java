...
//  =====================================================
    ...
    public void initialize() {
        ...
        helpBtn.setOnAction(event -> openHelpPdf());
...
//    }
    ...
    private void openHelpPdf() {
        try {
            File pdfFile = new File("src/main/resources/iuh/fit/help/huong_dan_su_dung.pdf");
            if (pdfFile.exists()) {
                Desktop.getDesktop().open(pdfFile);
            } else {
                System.out.println("Không tìm thấy file PDF!");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
